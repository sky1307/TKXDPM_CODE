...
public class Configs {
	...
	public static String[] PROVINCES = { "Bắc Giang", "Bắc Kạn", "Cao Bằng", "Hà Giang", "Lạng Sơn", "Phú Th�?",
			"Quảng Ninh", "Thái Nguyên", "Tuyên Quang", "Yên Bái", "�?iện Biên", "Hòa Bình", "Lai Châu", "Sơn La",
			"Bắc Ninh", "Hà Nam", "Hải Dương", "Hưng Yên", "Nam �?ịnh", "Ninh Bình", "Thái Bình", "Vĩnh Phúc", "Hà Nội",
			"Hải Phòng", "Hà Tĩnh", "Nghệ An", "Quảng Bình", "Quảng Trị", "Thanh Hóa", "Thừa Thiên-Huế", "�?ắk Lắk",
			"�?ắk Nông", "Gia Lai", "Kon Tum", "Lâm �?ồng", "Bình �?ịnh", "Bình Thuận", "Khánh Hòa", "Ninh Thuận",
			"Phú Yên", "Quảng Nam", "Quảng Ngãi", "�?à Nẵng", "Bà Rịa-Vũng Tàu", "Bình Dương", "Bình Phước", "�?ồng Nai",
			"Tây Ninh", "Hồ Chí Minh", "An Giang", "Bạc Liêu", "Bến Tre", "Cà Mau", "�?ồng Tháp", "Hậu Giang",
			"Kiên Giang", "Long An", "Sóc Trăng", "Ti�?n Giang", "Trà Vinh", "Vĩnh Long", "Cần Thơ" };
}
